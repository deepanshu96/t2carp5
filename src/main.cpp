      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          */
          ...
          x1 = v*cos(psi1)*latency;
          y1 = v*sin(psi1)*latency;
          psi1 = v*latency*latency/2.67;
          double v1 = v + a*latency;
          double cte1 = cte + (v*sin(epsi)*latency);
          double epsi1 = epsi + (v*atan(coeffs[1])*latency/2.67);
          ...
          {
              next_x_vals.push_back(t);
              next_y_vals.push_back(polyeval(coeffs,t));
          }
          //.. add (x,y) points to list here, points are in reference to the vehicle's coordinate system
